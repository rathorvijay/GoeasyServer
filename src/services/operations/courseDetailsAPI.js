...
export const getAllServices = async () => {
  ...
  let result = []
  try {
    const response = await apiConnector("GET", GET_ALL_SERVICE_API)
    if (!response?.data?.success) {
      throw new Error("Could Not Fetch Course Categories")
    }
    result = response?.data?.data
  } catch (error) {
    console.log("GET_ALL_SERVICE_API API ERROR............", error)
...
export const fetchServiceDetails = async (serviceId) => {
  ...
  try {
    ...
    console.log("SERVICE_DETAILS_API API ERROR............", error)
...
export const fetchServiceCategories = async () => {
  let result = []
  try {
    const response = await apiConnector("GET", SERVICE_CATEGORIES_API)
...
export const fetchAdminServices = async (token) => {
  ...
  try {
    ...
    console.log("Admin service API RESPONSE............", res.data)
    if (!res?.data?.success) {
      throw new Error("Could Not Fetch Admin service")
    }
    result = res?.data?.data
  } catch (error) {
    console.log("Admin service API ERROR............", error)
    toast.error(error.message)
  }
  toast.dismiss(toastId)
  return result
...
export const getFullDetailsOfService = async (serviceId, token) => {
  const toastId = toast.loading("Loading...")
  console.log("frontend fullapideaitls");
  //   dispatch(setLoading(true));
  let result = null
  try {
    ...
    console.log("SERVICE_FULL_DETAILS_API API RESPONSE............", response)
    ...
    console.log("SERVICE_FULL_DETAILS_API API ERROR............", error)
    result = error.response.data
    // toast.error(error.response.data.message);
  }
  toast.dismiss(toastId)
...
export const markLectureAsComplete = async (data, token) => {
  ...
  const toastId = toast.loading("Loading...")
  try {
    const response = await apiConnector("POST", BOOK_COMPLETION_API, data, {
      Authorization: `Bearer ${token}`,
    })
    console.log(
