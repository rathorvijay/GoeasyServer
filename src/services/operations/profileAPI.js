...
const { GET_USER_DETAILS_API, GET_USER_BOOKED_SERVICE_API, GET_ADMIN_DATA_API } = profileEndpoints
...
export async function getAdminData(token) {
  ...
  try{
    ...
    console.log("GET_ADMIN_API_RESPONSE", response);
