...
import { editServiceDetails } from "../../../../../services/operations/courseDetailsAPI"
...
export default function PublishCourse() {
  ...
  const handleServicePublish = async () => {
    ...
    if (
      (service?.status === SERVICE_STATUS.PUBLISHED &&
        getValues("public") === true) ||
      (service?.status === SERVICE_STATUS.DRAFT && getValues("public") === false)
    ) {
