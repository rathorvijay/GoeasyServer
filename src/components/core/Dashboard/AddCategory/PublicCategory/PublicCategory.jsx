...
import { editCategoryDetails } from "../../../../../services/operations/categoryAPI"
import { resetCategoryState, setStep } from "../../../../../slices/categorySlice"
...
const PublicCategory = () => {
  ...
  useEffect(() => {
    if (category?.status === CATEGORY_STATUS.PUBLISHED) {
  ...
  const handleCategoryPublish = async () => {
    ...
    if (
      ...
      (category?.status === CATEGORY_STATUS.DRAFT && getValues("public") === false)
    ) {
